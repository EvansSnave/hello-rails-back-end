...
The frontend project for this API can be found in the following link: [Hello React Frontend](https://github.com/EvansSnave/hello-react-front-end)
...
```
git clone https://github.com/EvansSnave/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/EvansSnave/hello-rails-back-end/issues).
